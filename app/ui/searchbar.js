export default function Searchbar() {
    return (
        ...
        <div className="text-black text-center py-10">
          <h1 className="text-4xl font-bold mb-3">Explore OpenAI Sora: Videos & Prompts</h1>
          <p className="text-lg">Discover OpenAI Sora Videos and Explore Engaging Sora Prompts.</p>
